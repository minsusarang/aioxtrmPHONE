...
const
    ctmpNormal                  =  1;
    ctmpAPIVersion              =  $30;
    ctmpNetWorkType: AnsiString =  'TCPIP';
    ctmpAppName: AnsiString     =  'sys_api'; //CTMPV3.0
    ctmpDefPbx                  =  0;
    ctmpInvok                   =  0;
...
{$IFDEF cti_NotReady_fis}
    ...
    TNotReady                  : array[1..9] of String = ('휴식', '점심', '게시판',
                                                         '교육', '작업', '채팅',
                                                         '다른업무', '개인이석', '원격지원');
{$ELSE}
   // 2020.12.15 고도화로 인한 이석코드변경
   TNotReady                   : array[1..9] of String = ('휴식', '식사', '티타임',
                                                         '교육', '회의', '상담',
                                                         '다른업무', '개인업무', 'WEB상담');     //cccm을 통해서 설정한다.
...
type
    ctmpCallType_Def = TOleEnum;
const
	    ctmpCT_None                  = 0;
	    ctmpCT_Inbound               = 1;    //인바운드콜
	    ctmpCT_Outbound              = 2;    //아웃바운드
	    ctmpCT_Internal              = 3;    //내부
	    ctmpCT_Consult               = 4;
	    ctmpCT_Transfer              = 5;
	    ctmpCT_Conference            = 6;
...
type
    ctmpTempArray          = array[0.. 4096] of AnsiChar;
...
//    ctmpPwdString          = array[0..ctmpMaxAgentId-1] of           char; //2011.03.03 삭제
    ctmpEmployeeString	   = array[0..ctmpMaxEmployeeLen      -1] of  Ansichar;   //* added by K.CH.S 2008.01.29 nexus */
    ctmpString30      	   = array[0..ctmpMaxLen30            -1] of  Ansichar;   //   /* added by K.CH.S 2008.01.29 nexuscube */
    ctmpString20	         = array[0..ctmpMaxLen20            -1] of  Ansichar;   //   /* added by K.CH.S 2008.01.29 nexuscube */
    ctmpAgentPath          = array[0..ctmpMaxAttDataLen       -1] of  Ansichar;
