...
const
    ...
    ctmpF_WaitTimeGetEx                 = 131;
    ctmpF_SystemData			= 140;{ CSTA }
    ctmpF_AvortStream			= 150;{ ASAI }
    ctmpF_QueryRoutePoinInfoEx          = 230;
    ...
    ctmpF_AgentBlocking                 = 204;

    ctmpF_ReadyRateGet                  = 239;
    ctmpF_SetAgentLeavingFlag           = 240;
...
type
    ...
    ctmpPwdString          = array[0..ctmpMaxAgentId-1] of           char;
