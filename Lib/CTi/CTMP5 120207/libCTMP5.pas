...
//    function GetAgentStatusEx(var AgentRec: TAgentRec; AID: ctmpDeviceString; DeviceNO: ctmpDeviceString ): Integer;
    ...
    function SetAgentStatus(aMode: ctmpAgentMode_Def; DN: String; aReasoncode: ctmpINT = 0): Integer; overload;
...
begin
  ...
  StrCopy(AgentData, PChar('000'));    //20110609
...
function TCTMP.SetAgentStatus(aMode: ctmpAgentMode_Def; DN: String; aReasoncode: ctmpINT = 0): Integer;
var
...
var
  nReturn: Integer;
begin
  Debug.Write(9, 31100, 'fCtiLogin :"Start", sCtiID :"'+sCtiID+'", sDevice :"'+sDevice+'"');
