...
uses WinTypes, WinProcs, Messages, SysUtils, Classes, Controls,
     Graphics, StdCtrls, Dialogs, syncobjs, winsock, varCTMP, constCTMP;
...
{Declare Function ctmpQueryAgentStatus Lib "CAPI" (ByVal gate As Long, _
                                                  ByVal invokeID As Integer, _
                                                  ByVal deviceDn As String, _
                                                  OutAgentMode As ctmpAgentMode_Def, _
                                                  ByVal OutAgentId As String, _
                                                  OutReasonCode As Long, _
                                                  privateData As ctmpPrivateData) As Long
...
function ctmpSendBroadcaseData( gate            :ctmpGateID;
                                invokeID        :ctmpInvokeID;
                                ioData          :ctmpDataPathType_Def) :u_int; stdcall; external DLLNAME;
