...
uses
  Windows, SysUtils, Classes, defCTMP5, constCTMP5, Forms, ComCtrls,
  varCTMP5,
//   varGateCTI,
 Dialogs;
type
...
{}
//  Result := GetAgentStatusEx(AgentRec, sAgentID, iDeviceNumber); //,TmrRec.Device
...
begin
  Debug.Write(1, 99991, 'SetAgentStatus '#13#10 + 'DN: ' + DN + #13#10'aMode :' + inttostr(amode) + #13#10 + 'agentID : ' + agentID );
  if DN = '' then
  begin
