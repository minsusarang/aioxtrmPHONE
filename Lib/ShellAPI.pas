...
begin
  if Win32MajorVersion >= 6 then
    ...
    Result := System.SizeOf(_NOTIFYICONDATAA) - System.SizeOf(TGUID) - System.SizeOf(Windows.HICON);
end;
...
begin
  if Win32MajorVersion >= 6 then
    ...
    // Platforms prior to Vista do not recognize the fields guidItem and hBalloonIcon
    Result := System.SizeOf(_NOTIFYICONDATAW) - System.SizeOf(TGUID) - System.SizeOf(Windows.HICON);
end;
